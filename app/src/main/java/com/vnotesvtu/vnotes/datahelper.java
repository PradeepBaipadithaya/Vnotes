...
public class datahelper extends SQLiteOpenHelper {
    String DB_PATH = null;
    private static String DB_NAME = "Vnotes";
...
//    }
    public Cursor get_subject_code(String key_value) {
        ...
        Cursor cursor = myDataBase.query("subject_table", new String[]{"subcode", "subname"}, "key_value=?", new String[]{String.valueOf(key_value)}, null, null, null);
